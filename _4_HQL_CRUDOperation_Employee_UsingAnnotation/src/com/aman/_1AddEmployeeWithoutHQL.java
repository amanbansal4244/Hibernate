...
public class _1AddEmployeeWithoutHQL {
	...
	public Integer addEmployee(String fName, String lName, int salary) {
		...
		try {
			...
			/**** if 'salary' data type is primitive data type and we forget to set the value then,
			 * In DB, by default value of data type will be set. ****/
			//e1.setSalary(salary);  
	...
	public static void main(String[] args) {
		...
		Integer empID1 = new _1AddEmployeeWithoutHQL().addEmployee("wwww", "Ali2", 10);
		Integer empID2 = new _1AddEmployeeWithoutHQL().addEmployee("wwwww", "Ali3", 101);	}
}
