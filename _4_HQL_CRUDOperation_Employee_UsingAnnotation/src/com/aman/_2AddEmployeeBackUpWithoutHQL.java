...
public class _2AddEmployeeBackUpWithoutHQL {
	...
	public static void main(String[] args) {
		...
		Integer empID1 = new _2AddEmployeeBackUpWithoutHQL().addEmployeeBackup("qqq", "dddd", 10);
		Integer empID2 = new _2AddEmployeeBackUpWithoutHQL().addEmployeeBackup("qqqq", "ddd", 101);	
