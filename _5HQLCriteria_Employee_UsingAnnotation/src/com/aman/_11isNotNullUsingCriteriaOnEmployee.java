...
public class _11isNotNullUsingCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.isNull("salary");//Make sure the salary is null.
			criteria.add(cn);
	...
	public static void main(String[] args) {
		new _11isNotNullUsingCriteriaOnEmployee().listEmployee();
	}
}
