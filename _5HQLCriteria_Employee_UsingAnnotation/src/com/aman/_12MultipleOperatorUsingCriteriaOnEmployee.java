...
public class _12MultipleOperatorUsingCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.and(Restrictions.like("firstName", "%Z%"),
									Restrictions.lt("salary", 2000));
	...
	public static void main(String[] args) {
		new _12MultipleOperatorUsingCriteriaOnEmployee().listEmployee();
	}
}
