...
public class _3LikeOperatorUsingCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.like("firstName", "%Z%");//Make sure the 'firstName' contains 'Z'
			criteria.add(cn);
	...
	public static void main(String[] args) {
		new _3LikeOperatorUsingCriteriaOnEmployee().listEmployee();
	}
}
