...
public class _10isNullUsingCriteriaOnEmployee2 {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.isNotNull("salary");//Make sure the salary is null.
			criteria.add(cn);
	...
	public static void main(String[] args) {
		new _10isNullUsingCriteriaOnEmployee2().listEmployee();
	}
}
