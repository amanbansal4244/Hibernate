...
public class _6CriteriaOrderingQueryOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			criteria.addOrder( Order.desc("salary") );//The result is sort by ‘salary’ in descending order.
	...
	public static void main(String[] args) {
		new _6CriteriaOrderingQueryOnEmployee().listEmployee();
	}
}
