...
public class _7LessThanAndEqualsToOperatorOfCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.le("salary", 2000);//Make sure the 'salary' is less than or equal to 20000.
	...
	public static void main(String[] args) {
		new _7LessThanAndEqualsToOperatorOfCriteriaOnEmployee().listEmployee();
	}
}
