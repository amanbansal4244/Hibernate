...
public class _9BetweenOperatorUsingCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.between("salary", 50, 100);//Make sure the salary is between 50 to 100.
			criteria.add(cn);
	...
	public static void main(String[] args) {
		new _9BetweenOperatorUsingCriteriaOnEmployee().listEmployee();
	}
}
