...
public class _2GreaterThanOperatorOfCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.gt("salary", 2000);//Make sure the 'salary' is greater than 20000.
			criteria.add(cn);
	...
	public static void main(String[] args) {
		new _2GreaterThanOperatorOfCriteriaOnEmployee().listEmployee();
	}
}
