...
public class _4LessThanOperatorOfCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.lt("salary", 2000);//Make sure the 'salary' is less than  20000.
			criteria.add(cn);
	...
	public static void main(String[] args) {
		new _4LessThanOperatorOfCriteriaOnEmployee().listEmployee();
	}
}
