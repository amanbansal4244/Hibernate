...
public class _5EqualThanOperatorOfCriteriaOnEmployee {
	...
	public void listEmployee() {
		...
		try {
			...
			Criterion cn =  Restrictions.eq("salary", 50000);//Make sure the 'salary' is equal to 50000.
			criteria.add(cn);
	...
	public static void main(String[] args) {
		new _5EqualThanOperatorOfCriteriaOnEmployee().listEmployee();
	}
}
